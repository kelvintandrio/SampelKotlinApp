...
class AdapterSearchMatch(private var list: SearchMatchFootball?, private var context: Context?)
        : RecyclerView.Adapter<AdapterSearchMatch.FootballMatchViewHolder>() {
